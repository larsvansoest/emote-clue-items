...
Celebrating grossing over 400 active installs within only a week after its release, version 1.2.0 of Emote Clue Items comes with an optimised widget engine to consistently highlight items accross multiple interfaces at lightning speed.
